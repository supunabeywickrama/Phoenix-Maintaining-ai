        ...
        try:
            ...
            if attachments:
                ...
                system_prompt += (
                    ...
                    "or a parts list (Ref. / Part Number / Description / Qty.) is available for it, "
                    "that table is the legend for those exact numbers. When the question is about a "
                    "specific part, give its ref number, description, part number and quantity "
                    "exactly as listed. Show "
